	...
	protected override IEnumerable<SectionModel> CreateItems() => new[]
		{
			 ...
			 new SectionModel(typeof(ViewsGalleryPage), "Views", Color.FromArgb("#00CDEC"),
				 "Views allow for reuse of UI components across your application (other frameworks refer to these as 'Controls' or 'Widgets')")
		};
}