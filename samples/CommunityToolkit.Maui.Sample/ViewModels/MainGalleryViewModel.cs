	...
	public MainGalleryViewModel()
		: base(new[]
		{
			 ...
			 SectionModel.Create<LayoutsGalleryViewModel>("Layouts", Color.FromArgb("#00EA56"),
				 "Layouts"),
			 SectionModel.Create<ViewsGalleryViewModel>("Views", Color.FromArgb("#00CDEC"), 
			 	 "Views allow for the reuse of UI components across your application (other frameworks refer to these as 'Controls' or 'Widgets')"),
		})
	{
